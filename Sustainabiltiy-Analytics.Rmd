...
The relevant Sustainable Developlment Goals[^sdg] (SDGs) are shown in \ref{fig:SDG-context}. The most relevant Sustainable Development Goal for the context of this report is SDG\ 7 (affordable and clean energy).

\begin{figure}[h]
  \centering
  \includegraphics[width=140mm]{SDG-context.png}
...
A stable grid infrastructure is important for the economy and many aspects of people's personal life (SDG 8 and 9). The production of clean energy also has an effect on SDG 14 and 15. However, there can also be risks concerning these goals. The building and maintaining of new power plants can endanger the habitat of various animals. If additional structures or power plants are needed to stabilize the grid, this could also pose risks concerning these goals.
...
## Scope of Analyis
The main question we want to analyse is whether increased variable renewable energy production on the Swiss grid relate to higher cost for control energy.

In the following chapter the data sources used for the analysis will be described following by a data exploration. The further analysis is then performed using Time Series Modelling methods.
...
In this report parts of the complex system of energy production was analyzed.
...
The cost of control energy was analyzed using the data provided by Swissgrid. The analysis of the yearly costs showed a rise in the costs after the year 2020. This period also showed larger variance in the hourly costs of control energy.

**Add text about time series results, influence VRES on Control costs, what was done in the last parts**
...
A limitation when looking at the control energy costs is the focus on the activated control energy. This is only part of the cost for Swissgrid and therefore the end-consumer. Another part is the cost for the capacity provision. For this cost no raw data was found but the cost is shown in a yearly report from the Federal Electricity Commission (ElCom)[^ELCOM-R-2022]. Those costs vary from approximately 50 - 200 Mio CHF from 2015 to 2021 with a sharp increase to almost 500 Mio CHF in 2022, exceeding the costs for the activation analyzed in this report.

A factor not considered in this report is the changes in the procurement procedure for control energy and the effects on the prices[^Procurement]. Another big influence affecting the prices are regulations and 

**Add text about international collaberation, trading plattforms..** 
...
**go further with Time-Series..**

**Work closer together with Stakeholder Swissgrid for example (get more data, get specific questions to adress)**

In this report the focus was set on Switzerland but he electricity market in Europe is very interdependent. The consideration of data about neighboring countries and transfers between the countries might give further insights and improve predictions on the cost of control energy.
