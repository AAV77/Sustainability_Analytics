...
Plot: Time series plot showing the average secondary and tertiary electricity price ranges over time.
Purpose: To visualize how the price ranges fluctuate over time.

```{r, time series of electricity prices, include = TRUE, warning = F}
...
ggplot(d, aes(x = Timestamp)) +
  ...
  labs(title = "Time Series of Average Secondary and Tertiary Price Ranges",
       x = NULL,
       y = "Price Range (CHF)") +
  scale_color_manual(name = "Price Range", 
                     values = c("Secondary Price Range" = "blue", "Tertiary Price Range" = "red"))
```
...
```{r, time series of vres percent, include = TRUE, warning = F}
...
ggplot(d, aes(x = Timestamp)) +
  ...
  labs(title = "Time Series of Variable Renewable Energy Sources Percentage",
       x = NULL,
       y = "VRES") +
  geom_smooth(aes(y = VRES_percent), method = "lm", se = FALSE, color = "orange") +
  scale_color_manual(name = "VRES", 
                     values = c("VRES Percent" = "darkgreen", "Linear Trend" = "orange"))
```
...
```{r, time series of actual vs. forecast, include = TRUE, warning = F}
