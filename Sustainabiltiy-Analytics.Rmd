...
The Vector Autoregression analysed in Chapter 5.3 indicates a causal relationship between VRES and hourly control energy costs with VRES lags influencing control costs. This relationship is confirmed by the Granger test, indicating that lags of VRES variability Granger-causes control costs. The VAR and Granger Causality analyses indicate that the effect of VRES on control energy prices is present but not straightforward. The direction of the effect is context-dependent, as the lags show both positive and negative impacts on control prices. However, it is clear that with more VRES integrated into the grid, the impact on control prices will increase, regardless of the direction of the effect. Swissgrid should consider using more detailed models to predict control energy prices as a function of VRES production.

We anticipate increasing VRES production, as indicated by the SARIMA model of daily VRES production, along with rising volatility and higher peaks in day-ahead electricity prices. The forecasted increase in VRES production suggests that anyone relying on a system affected by VRES should carefully evaluate its impact. For Swissgrid in particular, stronger effects on control energy prices can be expected, since, as demonstrated in the VAR and Granger causality analysis, control energy prices are influenced by VRES production.
