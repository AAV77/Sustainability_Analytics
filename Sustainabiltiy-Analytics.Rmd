...
ggplot(d.h, aes(x = cost_pos_sec_EUR)) + 
  geom_histogram(binwidth = 1000, fill = "blue", color = "black") +
  scale_y_log10() +
  ggtitle("Cost of Positive Secondary Control Energy in EUR")

# Hisd.h# Histogram for avg_secondary_price_range
ggplot(d.h, aes(x = cost_neg_sec_EUR)) + 
  geom_histogram(binwidth = 1000, fill = "blue", color = "black") +
  scale_y_log10() +
  ggtitle("Cost of Negative Secondary Control Energy in EUR")
