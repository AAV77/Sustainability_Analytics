...
Open Data on VRES Production in Europe, including Switzerland. Wind and Solar are the principal VRES.
...
# Plot for Wind Onshore Generation
ggplot(d.h_upto2020, aes(x = Timestamp, y = CH_wind_onshore_generation_actual_MW)) + 
  geom_line(color = "blue", size = 1) + 
  ggtitle("Wind Onshore Generation Over Time (Up to 2020)") +
  xlab("Time") +
  ylab("Wind Onshore Generation (MW)") +
  theme_minimal()


# Plot for Solar Generation
ggplot(d.h_upto2020, aes(x = Timestamp, y = CH_solar_generation_actual_MW)) + 
  geom_line(color = "orange", size = 1) + 
  ggtitle("Solar Generation Over Time (Up to 2020)") +
  xlab("Time") +
  ylab("Solar Generation (MW)") +
  theme_minimal()
...
ggplot(d.h_upto2020) + 
  ...
  geom_line(aes(x = Timestamp, y = CH_wind_onshore_generation_actual_MW, color = "Wind Onshore"), size = 1) + 
  ggtitle("Wind and Solar Generation Over Time (Up to 2020)") +
  xlab("Time") +
  ylab("Generation (MW)") +
  scale_color_manual(values = c("Wind Onshore" = "blue", "Solar" = "orange")) + 
  theme_minimal() +
...
ggplot(d.h_upto2020, aes(x = Timestamp, y = VRES_percent)) + 
