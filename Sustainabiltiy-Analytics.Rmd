...
```{r, outlier_detection1, eval = F, echo = FALSE, warning = F}
...
```{r, outlier_detection2, eval = F, echo = FALSE, warning = F}
# Calculate the IQR
...
```{r, decomp_baseload_clean, eval = F, echo = FALSE, warning = F}
# Decompose the time series
...
```{r, 2_order_diff_bl, eval = F, echo = FALSE, warning = F}
...
```{r, decomp_baseload_clean_2, eval = F, echo = FALSE, warning = F}
# Decompose the time series
...
```{r, day-ahead baseload_adf, include = T, eval = T, echo = FALSE, warning = F}
# Perform ADF test to check stationarity
...
```{r, acf_pacf_bl, eval = T, echo = FALSE, warning = F}
# Plot ACF and PACF
...
```{r, diff_season_bl, eval = T, echo = FALSE, warning = F}
# Diff seasonality
...
```{r, arima_bl, eval = T, echo = T, warning = F}
...
```{r, residuals_bl, eval = T, echo = FALSE, warning = F}
...
```{r, forecast_bl_1, eval = F, echo = FALSE, warning = F}
